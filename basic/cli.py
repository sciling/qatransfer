...
flags.DEFINE_string("data_dir", "data/wikiqa-class", "Data dir [data/squad]")
flags.DEFINE_string("run_id", "0", "Run ID [0]")
flags.DEFINE_string("out_base_dir", "out/wikiqa", "out base dir [out]")
...
flags.DEFINE_bool("freeze_span_modelling_layer", False, "Freeze modelling layer for span")
...
flags.DEFINE_integer("num_steps", 5000, "Number of steps [20000]")
...
flags.DEFINE_integer("save_period", 200, "Save Period [1000]")
...
flags.DEFINE_integer("sent_size_th", 500, "sent size th [64]")
